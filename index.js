...
const app = express();
app.use(express.static("../eas_one_to_one_client/build"));
app.use(cors());
...
// const MongoClient = require("mongodb").MongoClient;
// const uri = "mongodb://127.0.0.1:27017/sheikh_100s";
const uri =
  "mongodb+srv://aktcl:01939773554op5t@cluster0.9akoo.mongodb.net/sheikh_100s?retryWrites=true&w=majority";
const client = new MongoClient(uri, {
  useNewUrlParser: true,
  useUnifiedTopology: true,
});
client.connect((err) => {
  const userCollection = client.db("sheikh_100s").collection("users");
  const adminCollection = client.db("sheikh_100s").collection("admins");
  const leadsCollection = client.db("sheikh_100s").collection("leads");
      ...
      .updateOne(
        { _id: id },
        {
          $set: {
            ...
            answer7dot1: update.answer7dot1,
            answer8: update.answer8,
            answer9: update.answer9,
            answer10dot1: update.answer10dot1,
            answer10dot2: update.answer10dot2,
